    ...
    return (
        ...
        >
            <motion.g
                ...
                initial={{ y: '0px', x: '0px' }}
            >
                <motion.g animate={{ ...variants.tube }}>
                    <path
                        fill="none"
                        stroke="#e2f1f7"
                        strokeLinecap="butt"
                ...
                <motion.g animate={{ ...variants.head }}>
                    <path
                        fill="#a95ed4"
                ...
                <motion.g animate={{ ...variants.body }}>
                    <path
                        fill="#a95ed4"
